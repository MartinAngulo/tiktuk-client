...
const LoggedOutFooter = () => (
  <SimpleFooterContainer>
    <Routes>
      <Route path='/users/signup' element={<p>Do you already have an account?  <Link to={'/users/login'}>Log In</Link></p>} />
      <Route path='/users/login' element={<p>Don't you have an account yet?  <Link to={'/users/signup'}>Create an account</Link></p>} />
    </Routes>
  </SimpleFooterContainer>
)
