    ...
    <CenteredContainer>
      <SmallContainer>
        <form onSubmit={handleSubmit(onSubmit)}>
          <AppInput type="text" name="title" register={register} label="Title"></AppInput>
          <Fieldset>
            <label>Video File</label>
            <input type="file" {...register("video")} placeholder="Load a Video"></input>
          </Fieldset>
            <AppButton type="submit" small>Load Video</AppButton>
        </form>
      </SmallContainer>
    </CenteredContainer>
  )
